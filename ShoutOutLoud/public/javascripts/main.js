		...
		if($(window).width() <= 768){
			...
			$.ajax({
				...
				success:function(user,status){
					console.log(user);
					$(".content").append($('<div class="popup-profile"><div class="popup-boxer col-md-3"></div><div id="popup-mid" class="col-md-6"><div class="shout-container"><div class="shout"><div id="them"><img src="http://placehold.it/100x100"><h1>'+user.fullName+'</h1><h2>@'+user.handle+'<button class="btn btn-default follow-button" data-handle="'+user.handle+'">follow</button></h2></div><div class="profile-stats-container"><div class="profile-stats"><div class="col-md-4 col-sm-12"><p>Tweets</p><h3>'+user.numTweets+'</h3></div><div class="col-md-4 col-sm-12"><p>Followers</p><h3>'+user.numFollowers+'</h3></div><div class="col-md-4 col-sm-12"><p>Following</p><h3>'+user.numFollowing+'</h3></div><div class="clearfix"></div></div></div></div></div></div><div class="popup-boxer col-md-3"></div></div>'));
...
var newShout = function(user, tweet){
	...
	return $('<div class="shout-container"><div class="shout"><div class="shout-avatar"><img src="http://placehold.it/140x140"></div><div class="shout-data"><div class="shout-info"><a class="shout-names handle" data-handle="'+user.handle+'" href="#"><strong>'+user.fullName+'</strong><span>@'+user.handle+'</span></a><a class="shout-time" href="#">'+time+'</a><div class="clearfix"></div></div><div class="shout-content" tweet-id="'+tweet.id+'"></div>'+full+'</div><div class="clearfix"></div><div class="shout-options"><div class="btn">  <span class="glyphicon glyphicon-star"></span> Favorite</div><div class="btn">  <span class="glyphicon glyphicon-retweet"></span> Reshout</div><div class="btn">  <span class="glyphicon glyphicon-share-alt"></span> Reply</div></div><div class="clearfix"></div></div></div>');
}
var shout = function(){
	$.ajax({
		url:"/compose",
